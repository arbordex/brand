...
| --- | --- | --- | --- | --- | --- |
| ![Primary cyan logo](./arbordex-logo-cyan.svg) | ![Monochrome logo](./arbordex-logo-bw.svg) | ![Cyan mark](./arbordex-mark-cyan.svg) | ![Mono mark](./arbordex-mark-bw.svg) | ![Cyan wordmark](./arbordex-wordmark-cyan.svg) | ![Mono wordmark](./arbordex-wordmark-bw.svg) |
...
| Do | Don’t |
| --- | --- |
| <img src="./arbordex-logo-cyan.svg" alt="Cyan logo on light" width="180" style="background:#ffffff;padding:12px;border:1px solid #e8e8e8;"> | <img src="./arbordex-logo-cyan.svg" alt="Recolored (don’t)" width="180" style="filter:hue-rotate(120deg) brightness(0.8);padding:12px;border:1px solid #e8e8e8;"> |
| Use approved cyan on clean, high-contrast backgrounds. | Don’t recolor outside the approved palette. |
| <img src="./arbordex-mark-cyan.svg" alt="Mark as favicon" width="64" style="background:#0b0f1a;padding:8px;border-radius:12px;"> | <img src="./arbordex-mark-cyan.svg" alt="No outline" width="64" style="background:#ffffff;padding:8px;border:2px dashed #ff4d4f;"> |
